...
- **定向分发**：高报酬 / 高质量实验设置「最低信誉分门槛」，学生端列表**前端过滤**，未达标的实验直接不展示。
...
- [ ] 步骤 6+：实验管理、我的参与记录、个人中心、评分与审核（日志审计）……
...
> 开发说明：请在顶部导航栏右上角的「角色切换」下拉菜单中，随时在
> **学生端 / 研究者端** 之间切换；旁边的「语言」下拉用于切换 简体中文 / English / 日本語，用于联调与演示。
